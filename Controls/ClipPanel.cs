...
namespace Clips.Controls
{
    public class ClipPanel : BasePanel
    {
            ...
            try
            {
                ...
                if (m.Msg == WmClipboardupdate && MonitorClipboard)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Bitmap b = (Bitmap)obj.GetData(DataFormats.Bitmap, true);
                            if (GetClip(b) == null)
                                AddClipButton("", b);
                            b.Dispose();
                        }
        ...
        private void AddClipButton(string fileName, dynamic clipContents)
        {
            ...
            ClipButton b = new ClipButton(ClipsConfig, ButtonType.Clip, fileName, clipContents) { TabStop = false, Dock = DockStyle.Top };
        ...
        public void SetMonitorClipboard(bool doMonitorBoard) { MonitorClipboard = doMonitorBoard; }
